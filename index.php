...
$perso1 = new Personnage("ken", Personnage::FORCE_GRANDE, 0);
Personnage::parler();

$perso2 = new Personnage("vilain méchant pas gentil", Personnage::FORCE_PETITE);
Personnage::parler();


$perso1->setExperience(999999)->frapper($perso2)->getDegats();
